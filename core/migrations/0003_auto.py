...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field members on 'Association'
        m2m_table_name = db.shorten_name(u'core_association_members')
        ...
        db.create_unique(m2m_table_name, ['association_id', 'user_id'])
    ...
    def backwards(self, orm):
        # Removing M2M table for field members on 'Association'
        db.delete_table(db.shorten_name(u'core_association_members'))
    ...
    models = {
        ...
        u'core.association': {
            ...
            'administrator': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Administrator'", 'null': 'True', 'to': u"orm['core.User']"}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'fax': ('django.db.models.fields.CharField', [], {'max_length': '15', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'Members'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['core.User']"}),
