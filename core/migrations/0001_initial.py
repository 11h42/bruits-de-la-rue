...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_address', (
            ...
            ('recipient_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('zipcode', self.gf('django.db.models.fields.IntegerField')(max_length=10)),
        ...
        db.create_table(u'core_association', (
            ...
            ('url_site', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        # Adding M2M table for field associations on 'User'
        m2m_table_name = db.shorten_name(u'core_user_associations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'core.user'], null=False)),
            ('association', models.ForeignKey(orm[u'core.association'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'association_id'])

        # Adding M2M table for field address on 'User'
        m2m_table_name = db.shorten_name(u'core_user_address')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'core.user'], null=False)),
            ('address', models.ForeignKey(orm[u'core.address'], null=False))
        ))
        db.create_unique(m2m_table_name, ['user_id', 'address_id'])

        # Adding model 'BidCategory'
        db.create_table(u'core_bidcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'core', ['BidCategory'])
        ...
        db.create_table(u'core_bid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='creators', to=orm['core.User'])),
            ('purchaser', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='purchasers', null=True, to=orm['core.User'])),
            ...
            ('localization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Address'], null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.BidCategory'], null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(default='SUPPLY', max_length=20)),
            ('status_bid', self.gf('django.db.models.fields.CharField')(default=u'EN COURS', max_length=20)),
            ('real_author', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('association', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Association'], null=True, blank=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Photo'], null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field associations on 'User'
        db.delete_table(db.shorten_name(u'core_user_associations'))

        # Removing M2M table for field address on 'User'
        db.delete_table(db.shorten_name(u'core_user_address'))

        # Deleting model 'BidCategory'
        db.delete_table(u'core_bidcategory')
